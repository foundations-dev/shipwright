<template>
    <component :is="type" class="not-found">
        ...
        <Wrapper>
            ...
            <Paragraph
                >Couldn’t find a component that would match the URL you entered. Double check
                configuration in router/index.js.</Paragraph
            >
        </Wrapper>
    </component>
</template>
...
$color-template-background: $color-n900;
...
$color-template-text: $color-n000;
$color-template-link: $color-b300;

.not-found {
    @include reset;
    @include space-inset($space-m);
